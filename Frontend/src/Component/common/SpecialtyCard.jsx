...
export const sampleSpecialties = [
  {
    id: 1,
    name: 'Cardiology',
    description: 'Heart and cardiovascular system treatment with advanced cardiac care',
    icon: '❤️',
    doctorCount: 12,
    patientCount: 245,
    availableSlots: 8,
  ...
  },
  {
    id: 2,
    name: 'Neurology',
    description: 'Brain and nervous system disorders diagnosis and treatment',
    icon: '🧠',
    doctorCount: 8,
    patientCount: 189,
    availableSlots: 5,
  ...
  },
  {
    id: 3,
    name: 'Orthopedics',
    description: 'Bone, joint, and muscle treatment with modern techniques',
    icon: '🦴',
    doctorCount: 15,
    patientCount: 312,
    availableSlots: 12,
...
export const SpecialtyCardExamples = () => {
  ...
  return (
    <div className="p-8 space-y-8">
      <h2 className="text-2xl font-bold mb-6">Specialty Card Examples</h2>
      
      {/* Default Cards */}
      <div>
        <h3 className="text-lg font-semibold mb-4">Default Cards</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sampleSpecialties.slice(0, 3).map((specialty) => (
            <SpecialtyCard
              key={specialty.id}
              specialty={specialty}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {sampleSpecialties.slice(0, 4).map((specialty) => (
            <SpecialtyCard
              key={specialty.id}
              specialty={specialty}
              variant="compact"
      ...
      {/* Featured Cards */}
      <div>
        <h3 className="text-lg font-semibold mb-4">Featured Cards</h3>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {sampleSpecialties.slice(0, 2).map((specialty) => (
            <SpecialtyCard
              key={specialty.id}
              specialty={specialty}
              variant="featured"
