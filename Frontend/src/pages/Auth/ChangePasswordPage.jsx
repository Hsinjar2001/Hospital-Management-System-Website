          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <ul className="text-xs text-gray-600 space-y-1">
              <li className="flex items-center">
                <span className={`mr-2 ${newPassword && newPassword.length >= 8 ? 'text-green-500' : 'text-gray-400'}`}>•</span>
                At least 8 characters long
              </li>
              <li className="flex items-center">
                <span className={`mr-2 ${newPassword && /[A-Z]/.test(newPassword) ? 'text-green-500' : 'text-gray-400'}`}>•</span>
              ...
              <li className="flex items-center">
                <span className={`mr-2 ${newPassword && /[0-9]/.test(newPassword) ? 'text-green-500' : 'text-gray-400'}`}>•</span>
                One number
              </li>
              <li className="flex items-center">
                <span className={`mr-2 ${newPassword && /[@$!%*?&]/.test(newPassword) ? 'text-green-500' : 'text-gray-400'}`}>•</span>
